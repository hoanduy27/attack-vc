...
class AdaInVC(nn.Module):
    def __init__(self, config: Dict):
        ...
        self.content_encoder = ContentEncoder(**self.config["ContentEncoder"])
        self.speaker_encoder = SpeakerEncoder(**self.config["SpeakerEncoder"])
...
if __name__ == "__main__":
    ...
    speech = torch.rand((3, 512, 313))

    mu, logsig, emb, dec = model(speech)
